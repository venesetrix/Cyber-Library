...
Dealing with Evidence
    • Evidence preservation
        ...
        ○ Logical protection
    • Evidence Life cycle
        ○ Initial response - Evidence is identified and protected, CoC initiated
        ○ Collection - Acquiring through forensically sound processes, preserve integrity
        ○ Analysis - Analyzed at the technical level, determining innocence or guilt is the goal as well as identifiying the root cause of the incident
        ○ Presentation - Summarize evidence in the correct format
...
Forensics
    • Types of evidence
        ○ Direct evidence - Mündliche Aussage oder schriftliche Aussage eines Augenzeugen, die eine bestimmte Tatsache oder Frage beweist oder widerlegt.
        ○ Reas (physical) evidence - Greifbare Gegenstände des tatsächlichen Verbrechens. Kann auch Video- oder Audioüberwachungsbänder enthalten, die während oder nach der Veranstaltung erstellt wurden.
        ○ Documentary evidence - Originale und Kopien von Geschäftsunterlagen, computergenerierte und computergespeicherte Aufzeichnungen, Handbücher, Richtlinien, Standards, Verfahren und Protokolldateien. Tatsächlich handelt es sich bei den meisten Beweisen, die in einem Fall von Computerkriminalität vorgelegt werden, um dokumentarische Beweise.
        ○ Demonstrative evidence - Wird verwendet, um dem Gericht zu helfen, einen Fall zu verstehen. Meinungen gelten als demonstrative Beweise und können entweder Experten oder Nicht-Experten sein.
    • Rules
        ○ Authentic - Der forensische Prüfer muss für die Herkunft der Beweise verantwortlich sein.
        ○ Accurate - Die verwendeten Techniken und gesammelten Beweise dürfen die Echtheit der Beweise nicht in Frage stellen.
        ○ Complete -  Klar und vollständig sein und sollten die ganze Geschichte widerspiegeln.
        ○ Convincing - Welche Verfahren sie verwendet haben und wie die Integrität der Beweise gewahrt wurde.
        ○ Admissible  - Legaler Weg den Beweis zu erhalten.
...
Monitoring
    ...
    • Security Information and Event Management (SIEM)
        ...
        ○ Types
            § Kann als Managed Service Security Provider (MSSP) verwendet werden, der mit drauf schaut.
